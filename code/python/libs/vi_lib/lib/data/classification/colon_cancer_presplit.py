...
class ColonCancerPresplit(data.Dataset):
    ...
    def __init__(self, root, train=True):
        ...
        if self.train:
            self.training_file_x = os.path.join(self.root, "colon-cancer_presplit/colon-cancer_X_tr.csv")
            self.training_file_y = os.path.join(self.root, "colon-cancer_presplit/colon-cancer_y_tr.csv")
            ...
            self.test_file_x = os.path.join(self.root, "colon-cancer_presplit/colon-cancer_X_te.csv")
            self.test_file_y = os.path.join(self.root, "colon-cancer_presplit/colon-cancer_y_te.csv")
